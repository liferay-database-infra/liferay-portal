 ...
 */
public class PreupgradeDLStoreVerifyUtil {
	...
	public static String getFileSystemStoreRootDirPath(Connection connection) {
		...
		if (configurationPid != null) {
			try {
				...
				String rootDir = dictionary.get("rootDir");
				...
				if (_log.isWarnEnabled()) {
					_log.warn(
						"Unable to get file system store root dir path",
						exception);
				}
			}
		}

		return PropsValues.LIFERAY_HOME + "/data/document_library";
	}
	...
	private static final Log _log = LogFactoryUtil.getLog(
		PreupgradeDLStoreVerifyUtil.class);

...
public class IndexUpdaterUtil {
	...
	public static void updateAllIndexes() {
		if (!_processedBundleSymbolicNames.contains("portal")) {
			updatePortalIndexes();
		}
			...
			new BundleTrackerCustomizer<Void>() {
				...
				public Void addingBundle(
					...
					if (BundleUtil.isLiferayServiceBundle(bundle)) {
						try {
							if (!_processedBundleSymbolicNames.contains(
	...
	public static void updateIndexes(Bundle bundle) throws Exception {
		...
		_processedBundleSymbolicNames.add(bundle.getSymbolicName());
	}
	...
	public static void updatePortalIndexes() {
		...
		_processedBundleSymbolicNames.add("portal");
	}
	...
	private static final List<String> _processedBundleSymbolicNames =
		new ArrayList<>();

...
create unique index IX_60483743 on Address (externalReferenceCode[$COLUMN_LENGTH:75$], companyId, ctCollectionId);
...
create unique index IX_9868C9F on AssetCategory (externalReferenceCode[$COLUMN_LENGTH:75$], groupId, ctCollectionId);
...
create unique index IX_F6705A87 on AssetVocabulary (externalReferenceCode[$COLUMN_LENGTH:75$], groupId, ctCollectionId);
...
create unique index IX_8C21F15F on DLFileEntry (externalReferenceCode[$COLUMN_LENGTH:75$], groupId, ctCollectionId);
...
create unique index IX_6D9B1C7 on DLFolder (externalReferenceCode[$COLUMN_LENGTH:75$], groupId, ctCollectionId);
...
create unique index IX_D848D0DB on Organization_ (externalReferenceCode[$COLUMN_LENGTH:75$], companyId, ctCollectionId);
...
create unique index IX_F3A024C3 on UserGroup (externalReferenceCode[$COLUMN_LENGTH:75$], companyId, ctCollectionId);
...
create unique index IX_C05AA143 on User_ (externalReferenceCode[$COLUMN_LENGTH:75$], companyId, ctCollectionId);

...
create index IX_994AC32D on KBArticle (groupId, status, parentResourcePrimKey, latest);
create index IX_BA0BDE5F on KBArticle (groupId, status, parentResourcePrimKey, main);

...
public class ResourceActionPostUpgradeDataCleanupProcess
			...
			while (resultSet1.next()) {
				...
				if (StringUtil.startsWith(
					...
					StringUtil.startsWith(
						name, _NAME_PREFIX_OBJECT_DEFINITION_PORTLET_ID) ||
					StringUtil.startsWith(
						name, _NAME_PREFIX_OBJECT_DEFINITION_RESOURCE_NAME)) {
				...
				_objectDefinitionLocalService.fetchObjectDefinition(
					GetterUtil.getLong(
						StringUtil.removeSubstring(
							name,
							_NAME_PREFIX_OBJECT_DEFINITION_RESOURCE_NAME)));
	...
	private static final String _NAME_PREFIX_OBJECT_DEFINITION_PORTLET_ID =
		ObjectPortletKeys.OBJECT_DEFINITIONS + StringPool.UNDERLINE;

	private static final String _NAME_PREFIX_OBJECT_DEFINITION_RESOURCE_NAME =
		"com.liferay.object#";

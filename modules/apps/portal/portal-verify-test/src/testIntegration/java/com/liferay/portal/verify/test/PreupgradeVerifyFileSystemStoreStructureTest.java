...
public class PreupgradeVerifyFileSystemStoreStructureTest
	...
	public void testAdvancedFileSystemStoreWithLongDirectoryNameWithoutExtension()
		...
		_assertVerify(
			_ADVANCED_FILE_SYSTEM_STORE, directoryWithoutExtension, null,
			expectedMessage);
	}
	...
	public void testAdvancedFileSystemStoreWithValidStructure()
		...
		_assertVerify(_ADVANCED_FILE_SYSTEM_STORE, validDirectory, null);
	}
	...
	public void testFileSystemStoreWithDirectoryContainingExtension()
		...
		_assertVerify(
			_FILE_SYSTEM_STORE, directoryWithExtension, null, expectedMessage);
	}
	...
	public void testFileSystemStoreWithFileInsteadOfFolderIdDirectory()
		...
		_assertVerify(
			_FILE_SYSTEM_STORE, null, invalidFilePath, expectedMessage);
	}
	...
	public void testFileSystemStoreWithMissingValidVersionFiles()
		...
		_assertVerify(
			_FILE_SYSTEM_STORE, null, invalidVersionFile, expectedMessage1,
			expectedMessage2);
	}
	...
	public void testFileSystemStoreWithValidStructure() throws Exception {
		...
		_assertVerify(_FILE_SYSTEM_STORE, validDirectory, null);
	}
	...
	private void _assertVerify(
		...
		try {
			...
			_validateLogEntries(
				logCapture, expectedMessages.length, expectedMessages);
		}
		finally {
			logCapture.close();
	...
	private void _validateLogEntries(
		LogCapture logCapture, int expectedCount, String... expectedMessages) {

		List<LogEntry> logEntries = logCapture.getLogEntries();

		Assert.assertEquals(
			logEntries.toString(), expectedCount, logEntries.size());

...
import com.liferay.portal.verify.PreupgradeVerifyDLStoreWritePermission;
...
public class PreupgradeVerifyDLStoreWritePermissionTest
	...
	public void testVerifyNonexistentRootDirectory() throws Exception {
		...
		try {
			...
			Assert.assertEquals(
				"File system store directory does not exist: " + originalPath,
	...
	protected VerifyProcess getVerifyProcess() {
		return new PreupgradeVerifyDLStoreWritePermission();
	}

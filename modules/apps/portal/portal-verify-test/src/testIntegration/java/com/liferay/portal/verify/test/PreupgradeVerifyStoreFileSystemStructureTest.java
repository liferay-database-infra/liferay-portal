...
public class PreupgradeVerifyStoreFileSystemStructureTest
	...
	public void testAdvancedFileSystemStoreWithValidDirectory()
		...
		_assertVerify(
			_ADVANCED_FILE_SYSTEM_STORE, validDirectoryPath, null, null, null);
	}
	...
	public void testFileSystemStoreWithFileInsteadOfCompanyIdDirectory()
		...
		try {
			...
			_assertVerify(
				_FILE_SYSTEM_STORE, null, null, expectedExceptionMessage, null);
		}
		finally {
	...
	public void testFileSystemStoreWithFileInsteadOfFileNameDirectory()
		...
		_assertVerify(
			_FILE_SYSTEM_STORE, null, invalidFilePath, null, expectedLogEntry);
	}

	@Test
	public void testFileSystemStoreWithFileInsteadOfRepositoryIdDirectory()
		throws Exception {
	...
	public void testFileSystemStoreWithInvalidVersionLabelFile()
		...
		_assertVerify(
			_FILE_SYSTEM_STORE, null, invalidVersionLabelPath, null,
			expectedLogEntry);
	}
	...
	public void testFileSystemStoreWithValidDirectory() throws Exception {
		...
		_assertVerify(_FILE_SYSTEM_STORE, validDirectoryPath, null, null, null);
	}
	...
	private void _assertVerify(
			...
			String expectedExceptionMessage, String expectedLogEntry)
		throws Exception {

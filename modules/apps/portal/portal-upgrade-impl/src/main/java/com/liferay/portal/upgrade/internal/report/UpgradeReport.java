...
public class UpgradeReport {
	...
	public void generateReport(UpgradeRecorder upgradeRecorder) {
		...
		_propertiesFilePathStrings = _getPropertiesFilePathStrings();
	...
	private Map<String, Object> _getReportData(
		...
		return LinkedHashMapBuilder.<String, Object>put(
			...
			"document.library",
			LinkedHashMapBuilder.put(
				"root.dir", (_rootDir != null) ? _rootDir : "Undefined"
			).put(
			...
			"properties.files", _propertiesFilePathStrings
		).put(
	...
	private List<String> _propertiesFilePathStrings;

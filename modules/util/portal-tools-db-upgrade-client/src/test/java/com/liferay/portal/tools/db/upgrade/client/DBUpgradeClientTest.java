...
public class DBUpgradeClientTest {
	...
	public void testVerifyAppServerProperties() throws Exception {
		String[] answers = {
			StringPool.BLANK, "invalid-dir", _tomcatDir.getAbsolutePath(),
			"invalid-bin", "bin", "invalid-lib", "lib", "invalid-portal",
			"webapps/ROOT"
		};
	...
	private static void _createPropertyFiles() throws Exception {
		new File(
		...
		portalUpgradeExtPropertiesFile.createNewFile();

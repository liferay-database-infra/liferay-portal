...
## Usage
    ...
    -partition, --partition-id <arg> Set the partition to extract.
    -path,--path <arg> Set the output directory.

## Execution example
    java -jar com.liferay.portal.tools.db.partition.virtual.instance.migration.extractor.jar -url "jdbc:mysql://localhost:3306/lportal?useUnicode=true&characterEncoding=UTF-8&useFastDateParsing=false&useTimezone=true&serverTimezone=GMT" -user sourceUser -pass sourcePassword -partition lpartition_1234
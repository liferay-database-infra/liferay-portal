...
import {config as portalDbInfrastructureUpgradeAFSStoreConfig} from './tests/portal-db-infrastructure/upgrade-afs-store/config';
...
export default defineConfig({
	...
	projects: [
		...
		portalDbInfrastructureUpgradeAFSStoreConfig,
